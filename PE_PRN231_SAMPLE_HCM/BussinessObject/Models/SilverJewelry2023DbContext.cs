...
public partial class SilverJewelry2023DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__BranchAc__349DA586442FA488");

            entity.ToTable("BranchAccount");

            entity.HasIndex(e => e.EmailAddress, "UQ__BranchAc__49A147402E409FEB").IsUnique();
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B99ECD127");
        ...
        {
            entity.HasKey(e => e.SilverJewelryId).HasName("PK__SilverJe__1F1271978ED9D1D4");
